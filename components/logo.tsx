...
export default function Logo() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center mb-16 px-4">
      {/* Large Logo */}
      <div
        className="w-full max-w-2xl mx-auto mb-0 text-center transform transition-all duration-700"
        style={{
      ...
      >
        ...
        <h1 className="text-3xl md:text-5xl lg:text-6xl mb-2 leading-tight text-white" style={serifStyle}>
          "O'ziga bo'lgan ishonchni
        </h1>
        <h1 className="text-3xl md:text-5xl lg:text-6xl leading-tight text-white" style={serifStyle}>
          Maqsadlarga ta'siri"
        </h1>
      </div>
    </div>
